...
import type { UserPersona } from '@/app/providers';
...
export function Sidebar({ currentRoute, currentUser, onNavigate, isMobileOpen, onMobileClose }: SidebarProps) {
  ...
  const isAdmin = currentUser === 'Ana Admin';
