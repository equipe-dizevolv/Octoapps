...
function AppContent() {
  ...
  if (!isAuthenticated) {
    return (
      <>
        <LoginPage isDark={theme === 'dark'} onToggleTheme={toggleTheme} />
  ...
  const renderContent = () => {
    switch (currentRoute) {
      ...
      case 'calc-analise':
        return <AnalisePrevia calcId={selectedId} onNavigate={navigate} />;
      case 'calc-relatorio':
        return <RelatorioCompleto calcId={selectedId} onNavigate={navigate} />;
